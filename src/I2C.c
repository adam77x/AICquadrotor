...
init_I2C1_lowlevel();
Delay_1ms(100);
I2C_write(L3G4200D_ADDR, CTRL_REG1, 0x0F); // X,Y,Z eksenlerini aktif et ve 100Hz data çikis frekansi
I2C_write(L3G4200D_ADDR, CTRL_REG2, 0x00);
I2C_write(L3G4200D_ADDR, CTRL_REG3, 0x00); //eger istenilirse sensörün int2 (data hazir) interupti kullanilabilir
