...
/* Wait for a byte to be queued by the receive interrupts handler. */
	//My_Usart2_Printf(" okokok \n");
	My_Usart3_Printf("11111 \n"); 
 while (!xQueueReceive(xQueueUARTRecvie, &msg, portMAX_DELAY)); /////////////////////////////////////
	
	My_Usart3_Printf("22222 \n");
...
Motor_Control(PWM_MOTOR_MIN, PWM_MOTOR_MIN, PWM_MOTOR_MIN, PWM_MOTOR_MIN);
qprintf(xQueueUARTSend, "10 sec turn off motor\n\r");
}
...
// /*A Timer used to count how long there is no signal come in*/st
